...
public class BookStoreClient {
	public static void main(String[] args) {
		...
		Publisher publisher = new Publisher("MANN2", "1Manning Publications Co.");

		Book book = new Book("97816172910459", "Java Persistence with Hibernate, Second Edition", publisher);
